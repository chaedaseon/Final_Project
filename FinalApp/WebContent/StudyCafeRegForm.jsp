			...
			<div class="rightContent_div">
				...
				<div class="input-form-backgroud row">
					<div class="input-form-cafe col-md-12 mx-auto">
						<h4 class="mb-3">스터디카페 등록</h4>
						<form class="validation-form" novalidate>
							<div class="row">
								<div class="col-md-6 mb-3">
									<label for="CafeName">스터디카페명</label> 
									<input type="text" class="form-control" id="CafeName" placeholder="" value="" required="required">
									<div class="invalid-feedback">스터디카페명을 입력해주세요.</div>
								</div>
								<div class="col-md-6 mb-3">
									<label for="CafeNum">사업자등록번호</label> 
									<input type="text" class="form-control" id="CafeNum" placeholder="-를 제외하고 입력" value="" required="required">
							...
							<div class="row">
								...
								<div class="col-md-8 mb-3">
									...
									<input type="text" class="form-control" id="address" placeholder="서울특별시 강남구" required="required">
							...
							<button class="btn btn-lg btn-block" type="submit"
								style="background: #ddedb7;">등록</button>
						</form>
					</div>
