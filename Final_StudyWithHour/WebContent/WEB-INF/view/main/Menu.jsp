...
<nav class="py-2 bg-body-tertiary border-bottom top-area" style="box-shadow: 0px 1px 0px 0px #e1e1e1;">
	<div class="d-flex flex-wrap top-menu">
	    <div>
			<a href="studywithhour.do" class="align-items-center link-body-emphasis text-decoration-none">
	   	...
	   	<div class="nav-menu"> 
	    	...
	    	<div class="menu-area">
		   		<ul class="nav me-auto">
			    	<li class="nav-item">
			    		<a href="studywithhour.do" class="nav-link link-body-emphasis px-2 active" aria-current="page">Home</a>
		    		</li>
	     	...
	     	{%>
	     		<div class="dropdown text-end login-area">
		          ...
		          <ul class="dropdown-menu text-small">
		            <li><a class="dropdown-item" href="hostmypage.do">마이메뉴</a></li>
		            <li><hr class="dropdown-divider"></li>
		            <li><a class="dropdown-item" href="logout.do">Logout</a></li>
		          </ul>
		        </div>
