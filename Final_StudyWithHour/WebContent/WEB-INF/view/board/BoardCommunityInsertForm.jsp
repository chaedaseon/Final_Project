...
<head>
<meta charset="UTF-8">
<title>BoardCommunityInsertForm.jsp</title>
			...
			<div class="content_div">
				...
				<div class="sub_title_div">
					<div class="content_box">	<!--boardviewmodify.do  -->
						<form action="communityboardinsert.do" method="post" id="boardInsertForm">
						...
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="exampleFormControlInput1" name="boTitle">
						</div>
