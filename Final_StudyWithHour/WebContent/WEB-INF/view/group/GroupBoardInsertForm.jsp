			...
			<div class="rightContent_div">
				...
				<div class="sub_title_div">
					<div class="content_box">	<!--boardviewmodify.do  -->
						<form action="groupboardinsert.do?gu_code=${param.gu_code}&gr_code=${param.gr_code}" method="post" id="boardInsertForm">
						<div class="mb-3">
							<label for="exampleFormControlInput1" class="form-label" id="title">제목 </label>
							<span id="errCode1" style="display: none; color: red;"></span>
							<input type="text" class="form-control" id="exampleFormControlInput1" name="gbTitle">
						</div>
						...
						<div class="mb-3">
							...
							spellcheck="false" onkeyup="fn_checkByte(this)" name="gbContent"></textarea>
						</div>
						...
						<input type="hidden" id="gjCode" name="gjCode" value="${gjCode }"/>
						</form>
