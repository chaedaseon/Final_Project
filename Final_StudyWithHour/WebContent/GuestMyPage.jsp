...
<section>
	<div id="content">
		...
		<div class="rightContent_div">
			...
			<div class= "guMypage_div">
				<div class="guMypage">
					...
					<div class="guInfo_div">
						...
						<div class="guInfo" style="font-size: 30px;">
							<div>
							...
							<div class="guInfo_list2" id="guInfo_list2">
								<table>
									...
									<tr>
										<td>비밀번호</td>
										<td>
											<button type="button" class="modal_btn" data-bs-toggle="modal" data-bs-target="#modifyPw">
												변경하기
											</button>
										</td>
									</tr>
								        	...
								        	<div class="modal_form" style="margin-top: 10px;">
												<table>
													<tr>
														...
														<td><input type="text" class="upGuPw" id="upGuPw" name="upGuPw"></td>
													</tr>
													<tr>
														<td>비밀번호 확인</td>
														<td><input type="text" class="upGuPw" id="upGuPwCheck"></td>
													</tr>
												</table>
											</div>
								      	</div>
						...
						<form action="guestmodify.do?modifyType=all&guCode=<%= guest.getGuCode()%>" method="post" style="display: none; justify-content: space-evenly; width: 60%;" id="guUpdateForm">
							<div id="guInfo_modify" style="width: 100%;">
			...
			<!-- 회원 탈퇴 -->
			<div>
				<button type="button" class="modal_btn" data-bs-toggle="modal" data-bs-target="#unregBtn">
					  회원 탈퇴
					</button>
