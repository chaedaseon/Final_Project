			...
			<div class="content_div">
				<div class="search_div">
					<div class="search_description">
						<span style="color: #94bc32; font-weight: bold; font-size: 38px;">아이디</span><span style="color: #212529; font-size: 20px;"> 찾기</span>
					</div>	
					...
					<button type="submit" class="search_btn">아이디 찾기</button>
