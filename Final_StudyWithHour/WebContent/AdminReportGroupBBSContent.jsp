...
<head>
<meta charset="UTF-8">
<title>관리자 - 그룹게시판 신고컨텐츠.jsp</title>
...
<script type="text/javascript">
	...
	function process()
	{
		...
		var processForm = document.getElementById('groupBBSReportProcess');
	...
	function list(currPageNo, range, searchType, keyword) 
	{
		...
		var url = "adminreportgroupbbslist.do";
						...
						<table class="table ">
							<tbody>
								<tr>
									...
									<th>작성자</th>
									<td>
									<a href="adminguestinfo.do?guCode=${reportedUserCode }">
									${reportedUser }</a>
									</td>
								</tr>
							</tbody>
	                  ...
	                  <div class="modal fade  " id="ReportProcess" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	                    <div class="modal-dialog modal-dialog-centered">
	                      <div class="modal-content">
	                        ...
	                        <form id="groupBBSReportProcess"  action="" method="post">
	                          <button type="button" class="btn " data-bs-dismiss="modal">No</button>
	                          <input type="text" style="display: none;" id="code" name="code" value="${code }">
	                          <input type="text" style="display: none;" id="rpUser" name="rpUser" value="${report.rpUser }">
	                          <input type="text" style="display: none;" id="rtype" name="rtype" value="${rtype }">
	                          <input type="text" style="display: none;" id="reportedUserCode" name="reportedUserCode" value="${reportedUserCode }">
