...
public interface IAdminReportAllBBSDAO
{
	public ArrayList<ReportBBSDTO> allBBSlist(int vNum);
	public ReportBBSDTO reportContent(HashMap<String, Object> map); 
	
	public String userId(String guCode);
	
	public String replyBoardContent(String code);
	public String rereplyBoardContent(String code);
	
	public String boardTitle(String boCode);
	
	public void allBBSReportProcess(HashMap<String, Object> map);
