...
public class CommunityBoardController
{
	...
	public String communityBoardList(ModelMap model, Integer vNum)
	{
		...
		return "/CommunityBoardList.jsp";
		//return "/WEB-INF/view/CommunityBoardList.jsp";	// 커뮤니티 게시판 호출
	}
	...
	public String usedBookListSearchCategory(ModelMap model, @RequestParam("bsCode") String bsCode ,@RequestParam("vNum") int vNum)
	{
		...
		return "/UsedBookBoardList.jsp";
		//return "/WEB-INF/view/UsedBookBoardList.jsp";	// 커뮤니티 게시판 호출
	}
    ...
    {
		return "/BoardCommunityInsertForm.jsp";
		//return "/WEB-INF/view/WritePostForm.jsp";		// 커뮤니티 게시글 작성 폼 호출
    }
