...
public class GuestGroupActiveListController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try
		{
			...
			ArrayList<GroupDTO> groupActiveList = new ArrayList<GroupDTO>();
			
			groupActiveList = group.groupActiveList(guCode);
			mav.addObject("groupActiveList", groupActiveList);
			
			
			/* mav.setViewName("/WEB-INF/view/GuestGroupActiveList.jsp?guCode="+guCode); */
			mav.setViewName("GuestGroupActiveList.jsp?guCode="+guCode);
